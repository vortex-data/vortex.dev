...
Development keeps moving quickly, we released [0.54.0](https://github.com/vortex-data/vortex/releases/tag/0.54.0) with many new features and improvements to the Rust API. This month we accepted 188 commits from 13 different contributors, with the relentless renovate-bot taking the crown for most changes merged.
